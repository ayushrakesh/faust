...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    DEF = 345,                     /* DEF  */
    IMPORT = 346,                  /* IMPORT  */
    COMPONENT = 347,               /* COMPONENT  */
    LIBRARY = 348,                 /* LIBRARY  */
    ENVIRONMENT = 349,             /* ENVIRONMENT  */
    WAVEFORM = 350,                /* WAVEFORM  */
    ROUTE = 351,                   /* ROUTE  */
    ENABLE = 352,                  /* ENABLE  */
    CONTROL = 353,                 /* CONTROL  */
    IPAR = 354,                    /* IPAR  */
    ...
    CASE = 365,                    /* CASE  */
    ARROW = 366,                   /* ARROW  */
    ASSERTBOUNDS = 367,            /* ASSERTBOUNDS  */
    LOWEST = 368,                  /* LOWEST  */
    HIGHEST = 369,                 /* HIGHEST  */
    FLOATMODE = 370,               /* FLOATMODE  */
    DOUBLEMODE = 371,              /* DOUBLEMODE  */
    QUADMODE = 372,                /* QUADMODE  */
    FIXEDPOINTMODE = 373,          /* FIXEDPOINTMODE  */
    BDOC = 374,                    /* BDOC  */
    EDOC = 375,                    /* EDOC  */
    BEQN = 376,                    /* BEQN  */
    EEQN = 377,                    /* EEQN  */
    ...
    BLST = 380,                    /* BLST  */
    ELST = 381,                    /* ELST  */
    BMETADATA = 382,               /* BMETADATA  */
    EMETADATA = 383,               /* EMETADATA  */
    DOCCHAR = 384,                 /* DOCCHAR  */
    NOTICE = 385,                  /* NOTICE  */
    LISTING = 386,                 /* LISTING  */
    LSTTRUE = 387,                 /* LSTTRUE  */
    LSTFALSE = 388,                /* LSTFALSE  */
    LSTDEPENDENCIES = 389,         /* LSTDEPENDENCIES  */
    LSTMDOCTAGS = 390,             /* LSTMDOCTAGS  */
    LSTDISTRIBUTED = 391,          /* LSTDISTRIBUTED  */
    LSTEQ = 392,                   /* LSTEQ  */
    LSTQ = 393                     /* LSTQ  */
  };
